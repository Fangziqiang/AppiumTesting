#需要领积分的应用
#我的oppo
#1、com.oppo.usercenter/com.oppo.usercenter.vip.UCVIPMainActivity
#oppo+
...
#8、 com.coloros.yoli/com.coloros.yoli.maintab.ui.MainTabActivity
#9、 com.android.browser/com.android.browser.BrowserActivity
#
#
#
